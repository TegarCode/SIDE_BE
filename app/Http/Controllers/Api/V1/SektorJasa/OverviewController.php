...
use App\Services\SektorJasa\OverviewService;
...
class OverviewController extends Controller
{
    ...
    public function overview(Request $request): JsonResponse
    {
        ...
        if ($useCache) {
            $ttl = now()->endOfDay();
            $keyNilai = $this->buildCacheKey('jasa-overview:nilai', $filters);
            $keyStats = $this->buildCacheKey('jasa-overview:stats', $filters);
        ...
        return ApiResponse::success(
            $payload,
            'Ikhtisar sektor jasa berhasil diambil',
