...
namespace App\Http\Requests\NegaraMitra\Investasi;

use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Facades\Log;

class OverviewInvestasiMultiRequest extends FormRequest
{
  ...
  public function sanitizedFilters(): array
  {
    ...
    $destIn   = $f['dest'] ?? $f['destination'] ?? $this->input('dest', $this->input('destination'));
