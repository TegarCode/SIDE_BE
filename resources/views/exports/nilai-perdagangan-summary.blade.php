...
<body>
    ...
    <div class="title-block">
        <h1>EVALUASI KINERJA NILAI PERDAGANGAN INDONESIA {{ $latestYear }}</h1>
    ...
    <div class="section-title">I. KINERJA PERDAGANGAN INTERNASIONAL</div>
    <div class="section-subtitle">
        Bagian ini menyajikan ringkasan tren nilai perdagangan dalam beberapa tahun terakhir serta peringkat mitra dagang utama pada tahun {{ $latestYear }}.
    </div>
    ...
    <div class="chart-grid">
        ...
        <div class="chart-col">
            <div class="chart-box">
                <div class="chart-title">Top 5 Mitra Dagang ({{ $latestYear }})</div>
    ...
    <div class="section-title" style="margin-top: 8px;">Tabel Top 10 Mitra Dagang</div>
    <div class="muted">
        @if ($prevYear)
