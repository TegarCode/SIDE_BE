...
<body>
    ...
    <div class="title-block">
        <h1>RINGKASAN PERDAGANGAN INTERNASIONAL SEKTOR MINERAL KRITIS INDONESIA</h1>
        <p>
            Perdagangan mineral kritis global dan bilateral produk mineral kritis ({{ $produkMeta['reporter'][0]['nama'] ?? '-' }}
            ke {{ $produkMeta['partner'][0]['nama'] ?? '-' }})
        </p>
    </div>

    <div class="summary">
        Ringkasan ini menyajikan perdagangan internasional sektor mineral kritis berdasarkan daftar HS terpilih pada rentang tahun
        ...
        Selain itu, ringkasan memetakan 20 negara mitra terbesar dan 20 produk mineral kritis utama pada tahun terbaru,
        berikut perbandingan dengan tahun sebelumnya untuk melihat dinamika dan konsentrasi perdagangan.
        Sub-bagian bilateral produk mineral kritis menekankan arah perdagangan dari asal ke tujuan yang dipilih,
    ...
    <div class="section-subtitle">
        Tren berikut menunjukkan kinerja perdagangan mineral kritis Indonesia terhadap dunia pada periode
        {{ $years ? min($years) : '-' }}-{{ $years ? max($years) : '-' }} dengan satuan {{ $unit }}.
        Ekspor dan impor menggambarkan arus barang mineral kritis yang keluar dan masuk, sementara nilai perdagangan
    ...
    <div class="section-title">Perdagangan Produk Mineral Kritis Bilateral</div>
    <div class="section-subtitle">
        Bagian ini merangkum arus perdagangan produk mineral kritis dari {{ $produkMeta['reporter'][0]['nama'] ?? '-' }}
    ...
    <div class="section-subtitle">
        ...
        sehingga terlihat arah perubahan ekspor produk mineral kritis utama dari {{ $produkMeta['reporter'][0]['nama'] ?? '-' }}
        ke {{ $produkMeta['partner'][0]['nama'] ?? '-' }}.
    </div>
    <table class="data-table">
        <thead>
